...
# Create a drop down menu on the side
selectInput(inputId = "borough_choice",
            label = h3("Select Borough"), # heading 3
...
# Create a radio button list on the side
radioButtons(inputId = "room_choice",
